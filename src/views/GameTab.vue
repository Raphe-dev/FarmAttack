<template>
  <ion-page>
    ...
    <ion-content>
      <Game/>
      <div style="width: 5rem; height: 5rem; display: flex; align-items: center; justify-content: center; padding: 1rem; background-color: pink; border-radius: 100%; position: absolute; bottom: 0.5rem; right: 0.5rem;">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 290.226 290.226" xml:space="preserve">
        <g>
